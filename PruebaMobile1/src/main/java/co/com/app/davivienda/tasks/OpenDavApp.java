...
import static co.com.app.davivienda.utilidades.constantes.Datos.getNroDocumento;
import static co.com.app.davivienda.utilidades.constantes.Datos.getClave;
...
public class OpenDavApp implements Task {
	...
	public <T extends Actor> void performAs(T actor) {
		actor.attemptsTo(WaitUntil.the(TXT_NRO_DOCUMENTO, isVisible()), 
				Enter.theValue(getNroDocumento()).into(TXT_NRO_DOCUMENTO),
				Click.on(BTN_INGRESAR),
				Enter.theValue(getClave()).into(TXT_CLAVE),
